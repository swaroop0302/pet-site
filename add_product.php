...
<head>
    ...
    <title>Add Product - PetHaven Admin</title>
...
.form-container {
    ...
    /* Add this to make form elements utilize the wider space */
    .form-group input,
    .form-group textarea,
    .form-group select {
        max-width: 100%;
   ...
   <div class="sidebar">
    ...
    <div class="form-container">
        ...
        <div class="supplier-form">
            <h1 class="form-title">Product Information</h1>
            ...
            <form action="save_product.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select id="category" name="category" required>
                        ...
                        <option value="CatToy">CatToy</option>
                        <option value="DogFood">DogFood</option>
                        <option value="DogToy">DogToy</option>
    ...
    <!-- Include JavaScript from add_supplier.php -->
    <script>
