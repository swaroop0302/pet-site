...
$stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'medicine'");
$stmt->execute();
...
<?php endif; ?>
    ...
    <!-- category-bar -->
     <div class="category-bar">
        ...
        <div class="category-tab active" data-category="medicine">
            <a href="medicine.php">
    ...
    <div class="container">
        <h2 class="h2 section-title">
            <span class="span">Medicine</span> Products
        </h2>
