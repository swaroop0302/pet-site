...
$stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'Supply'");
$stmt->execute();
...
<?php endif; ?>
    ...
    <div class="category-bar">
        ...
        <div class="category-tab active" data-category="Supply">
...
<div class="container">
        <h2 class="h2 section-title">
            <span class="span">Supplements</span> Products
        </h2>
