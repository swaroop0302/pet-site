...
<head>
    ...
    <title>Add Supplier - PetHaven Admin</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css">
    <style>
        /* Copy all CSS from admin.php */
        * {
            margin: 0;
            padding: 0;
...
<div class="supplier-form">
    <h1 class="form-title">Supplier Information</h1>
    
    <form action="save_supplier.php" method="POST">
        <!-- All form groups properly nested -->
    ...
    <!-- Include JavaScript from admin.php -->
    <script>
