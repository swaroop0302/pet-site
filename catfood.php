...
$stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'CatFood'");
$stmt->execute();
...
<?php endif; ?>
    ...
    <div class="category-bar">
        ...
        <div class="category-tab active" data-category="CatFood" style="margin-left: 360px;">
            <a href="catfood.php">
        ...
        <div class="category-tab" data-category="birdfood">
            <a href="birdfood.php">
